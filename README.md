...
Current release: [**v0.9.7**](https://github.com/nornzach/oh-my-pi-gui/releases/tag/v0.9.7)

- **Apple Silicon (M1/M2/M3/M4):** `omp-0.9.7-arm64.dmg`
- **Intel:** `omp-0.9.7.dmg`
...
当前版本：[**v0.9.7**](https://github.com/nornzach/oh-my-pi-gui/releases/tag/v0.9.7)
